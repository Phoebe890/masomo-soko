                    ...
                    <Toolbar sx={{ justifyContent: 'space-between' }}>
                        ...
                        <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
                            ...
                            <Menu 
                                ...
                                PaperProps={{ elevation: 0, sx: { overflow: 'visible', filter: 'drop-shadow(0px 2px 8px rgba(0,0,0,0.32))', mt: 1.5, minWidth: 200 } }}
                            ...
                            >
                                ...
                                <MenuItem onClick={() => { setAnchorEl(null); onTabChange('settings'); }}>
                                    <ListItemIcon><SettingsOutlinedIcon fontSize="small" /></ListItemIcon> Settings
                                </MenuItem>
                                <Divider />
                                <MenuItem onClick={handleLogout} sx={{ color: 'error.main' }}>
                                    <ListItemIcon><LogoutOutlinedIcon fontSize="small" color="error" /></ListItemIcon> Logout
                                </MenuItem>
                            </Menu>
                        </Box>
                    </Toolbar>
