...
import { 
    ...
    alpha, Divider, createTheme, ThemeProvider, Skeleton // Added Skeleton
} from '@mui/material';
...
const UploadFirstResource = () => {
    ...
    const [initialLoading, setInitialLoading] = useState(true); // New state for skeleton
                    ...
                    {initialLoading ? (
                        ...
                        <Box>
                            <Box sx={{ mb: 4, display: 'flex', alignItems: 'center', gap: 2 }}>
                                <Skeleton variant="rectangular" width={42} height={42} sx={{ borderRadius: '2px' }} />
                                <Box>
                            ...
                            <Grid container spacing={4}>
                                <Grid item xs={12} md={8}>
                                    <Paper sx={{ p: 4, border: `1px solid ${BORDER_COLOR}`, borderRadius: '2px' }}>
                                ...
                                <Grid item xs={12} md={4}>
                                    <Stack spacing={3}>
                                        <Paper sx={{ p: 3, border: `1px solid ${BORDER_COLOR}`, borderRadius: '2px' }}>
